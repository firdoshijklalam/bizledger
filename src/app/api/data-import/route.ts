        ...
        if (opts.updateExisting) {
          await tx.invoice.upsert({
            ...
            update: {
              ...
              grandTotal: inv.grandTotal, deliveryCharge: inv.deliveryCharge ?? 0, saleOperationId: inv.saleOperationId ?? null, amountPaid: inv.amountPaid, amountDue: inv.amountDue,
